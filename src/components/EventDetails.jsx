import React, { useEffect } from 'react'; // ✅ CHANGED: Imported useEffect
...
const upcomingEvents = [
  {
    ...
    description:
      'Join us for a deep dive into the future of Artificial Intelligence, featuring talks from industry experts and IEEE researchers. This full-day event includes keynote sessions, technical workshops, and networking opportunities with pioneers in the AI field.',
    image:
      'https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&w=1170&q=80', // 🤖 AI-focused conference scene with futuristic vibe
  ...
  },
  {
    ...
    description:
      'A 48-hour hackathon powered by IEEE, bringing together student developers, designers, and innovators to solve real-world challenges. Compete for amazing prizes, attend mentorship sessions, and build something incredible.',
    image:
      'https://images.unsplash.com/photo-1522199755839-a2bacb67c546?auto=format&fit=crop&w=1170&q=80', // 👨‍💻 Hackathon/team coding environment
    registerLink: 'https://forms.gle/kHf5oDeBJhGssJhu8',
...
const EventDetail = () => {
  ...
  // ✅ NEW: Scroll to top on component load
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  if (!event) {
    return (
        // This container is transparent, allowing the app's background to be visible.
        <div className="relative py-24 px-6 md:px-20 lg:px-32 min-h-screen flex justify-center items-center">
            ...
            >
                ...
                <Link to="/events" className="mt-8 inline-flex items-center bg-ieee-blue text-white px-6 py-3 rounded-lg hover:bg-ieee-blue-dark transition shadow-lg font-semibold">
  ...
  return (
    // This main container is transparent, allowing the app's background to be visible.
    <div className="relative py-24 px-6 md:px-20 lg:px-32 text-gray-900 min-h-screen overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
            ...
            >
                ...
                <motion.div variants={itemVariant} className="grid grid-cols-1 md:grid-cols-3 gap-8 text-gray-700">
                    <div className="flex items-center gap-4">
                        <FiCalendar className="text-ieee-blue text-3xl flex-shrink-0" />
                        <div>
                    ...
                    <div className="flex items-center gap-4">
                        <FiClock className="text-ieee-blue text-3xl flex-shrink-0" />
                        <div>
                    ...
                    <div className="flex items-center gap-4">
                        <FiUsers className="text-ieee-blue text-3xl flex-shrink-0" />
                        <div>
                 ...
                 <motion.div variants={itemVariant} className="flex items-center gap-4 mt-6 text-gray-700">
                    <FiMapPin className="text-ieee-blue text-3xl flex-shrink-0" />
                    <div>
            ...
            <motion.div
                ...
                transition={{ duration: 0.8, ease: 'easeOut' }}
            >
                {/* <h2 className="text-4xl font-extrabold text-white text-center mb-10">Register for the Event</h2> */}
