    ...
    <div className="relative py-24 px-6 md:px-20 lg:px-32 text-gray-900 overflow-hidden">
        ...
        <div className='relative w-screen h-[400px] -mx-6 md:-mx-20 lg:-mx-32 -mt-24 mb-24 overflow-hidden'>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
                ...
                >
                    The dedicated team of student leaders driving innovation and excellence at IEEE RSET SB for the 2025 tenure.
                </motion.p>
            </div>
        </div>
                ...
                >
                    {members.map((member, index) => (
                        <motion.div
                            ...
                            className="group bg-white/90 backdrop-blur-sm border border-gray-200 rounded-2xl shadow-md transition-all duration-300 hover:shadow-2xl hover:border-blue-600/60 overflow-hidden cursor-pointer"
                        ...
                        >
                            ...
                            <div className='p-5 text-center'>
                                <h5 className='text-md font-bold text-gray-800 group-hover:text-blue-700 transition-colors leading-tight truncate'>{member.name}</h5>
